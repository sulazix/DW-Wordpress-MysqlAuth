...
// ADD wp-hash as a possible passcrypt option
$meta['passcrypt']   = array('multichoice','_choices' => array('smd5','wp-hash','apr1','sha1','ssha','lsmd5','crypt','mysql','my411','kmd5','pmd5','hmd5','mediawiki','bcrypt','djangomd5','djangosha1','sha512'));
